...
Service.create( brand: "Cool boat brand", part: "Engine block", description: "These is the text field for the database", level: 3, video_url: "http://youtube.com", user_id: 4, created_at: null, updated_at: null)
